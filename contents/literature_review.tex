...
\autocite{Abadi2013}.
In approximately 2011 initial research was conducted into the potential applications of columnar storage in the context of Big Data frameworks.
Subsequently, this research culminated the development of Apache Parquet and Apache ORC, both disk-based columnar formats.
\autocite{Floratou2019}
...
It has implementations in many languages (see \autoref{subsubsection:arrow:langs} for a list).
...
The specification includes a physical memory layout for each type.
...
It incorporates convenient abstractions such as DataFrames and Series.
