...
These Arrow arrays are different from JavaScript arrays, as they cannot contain different data types.
...
Arrow has a more granular type system than JavaScript. This allows for a more precise control of memory.
Arrow types can have parameters.
For example instead of JavaScript \Verb|number|, Arrow has (un)signed integers with a bit width parameter,
...
\begin{figure}
	...
	\caption{Example how Arrow increases interoperability between processes \autocite{Ahmad2020}}
	\label{fig:arrow_com}
\end{figure}
