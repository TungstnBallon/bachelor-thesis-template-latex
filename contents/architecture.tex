...
Polars is a high level library built on top of Apache Arrow, which also offers useful abstractions like DataFrames, that hide the Arrow data types.
...
%TODO mention feature flag requirement
...
\begin{figure}
	\begin{plantuml}
		...
		@enduml
	\end{plantuml}
	\caption{The Jayvee execution extensions} %TODO: idk
...
This block can receive \Verb|BinaryFile| from multiple blocktypes, including \Verb|LocalFileExtractor| and \Verb|HTTPExtractor|.
...
% This subsection is only concerned with the executor of this blocktype, the architecture of transforms is explained in \autoref{section:transforms}, expressions in \autoref{section:expressions}.
