...
This prototype is based on the \emph{Polars} library.
By using this library, the prototype implements the \emph{Apache Arrow} specification.
...
The external library \emph{sqlite-loader-lib} was developed.
This library implements database functionality that is not present in \emph{Polars}.
\emph{sqlite-loader-lib} was shown to be more performant than the other approaches.
