...
\begin{enumerate}
	...
	\item[FR-6] \textbf{extensibility} The functionality of the chosed data representation must be extensible.
...
\begin{enumerate}
	...
	\item[NFR-2] \textbf{codestyle} The source code adheres to the project's code style.
