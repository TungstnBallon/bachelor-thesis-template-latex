...
\begin{enumerate}
	\item[FR-1] \textbf{interoperability}: Provided by the standardized \emph{Apache Arrow}. %FIXME between what
	...
	\item[FR-4] \textbf{compatibility}: Execute the electric vehicles example described in \Verb|electric-vehicles.jv| (\autoref{tab:src}) without errors.
