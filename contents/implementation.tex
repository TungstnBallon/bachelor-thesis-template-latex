...
- uses if instead of switchcase to make it clear that this is equals instead of ===
...
It does't have any methods, that aren't getters, setters or wrappers around equivalent \Verb|Series| methods or attributes.
...
To retrieve the type information lost during this process, the typeguards described in \autoref{subsection:TypeConversion} were utilized.
...
It was determined, that unsupportrd ValueTypes should be included in the table as unparsed strings, while still logging an error.
...
- IMPORTANT: has to keep using the method \Verb|addColumn| to remain compatribility requirement.
