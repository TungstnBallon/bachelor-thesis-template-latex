...
\begin{table}[H]
	\caption{Average duration of the block \Verb{LiquorLoader} for a pipeline with no transforms (10 repetitions).}
...
\begin{table}[H]
	...
	\begin{center}
		\begin{tabularx}{\textwidth}{|l|l|l|X|}
			...
			\hline
			texlive          & 2024.2    & thesis document   & \url{https://tug.org/texlive/}                    \\
			plantuml         & 1.2023.13 & thesis document   & \url{https://plantuml.com/}                       \\
			\hline
		\end{tabularx}
	\end{center}
\end{table}
