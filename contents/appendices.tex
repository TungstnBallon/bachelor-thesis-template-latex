...
\begin{table}
	\caption{The result of the execution time of ts divided by PLOBRS. Columns 1-3 are the amount of transforms}
...
\begin{table}
	...
	\begin{center}
		\begin{tabular}{|l|l|}
			\hline
			filename                                  & containing folder relative to the project root                  \\
			\hline
			...
			transform-executor.ts                     & lib/execution/src/lib/transforms/                               \\
			                                          &                                                                 \\
			                                          &                                                                 \\
			                                          &                                                                 \\
			                                          &                                                                 \\
