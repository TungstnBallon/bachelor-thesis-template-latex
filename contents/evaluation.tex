...
\begin{enumerate}
	\item[NFR-1] \textbf{performance} \ref{eval:numbers} demonstrated that the optimizations afforded by the new implementation enhance processing speeds,
	      \ref{eval:max_size}  illustrated that the new implementation is capable of accommodating greater input data without crashing.
